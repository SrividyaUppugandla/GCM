...
| some condition | The condition should be passed here. e.x: if the condition is like "x is equals to 1"  then "x" has to be passed as header key and 1 will be value of header. |
