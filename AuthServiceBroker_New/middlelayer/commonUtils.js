...
exports.pushApp = function (options, callback) {
    ...
    var push = function (app, callback) {
        ...
        Apps.add(appOptions).then(function (result) {
            ...
            Apps.setToken(token);
            return Apps.upload(appGuid, options["zippedPath"], false);
        }).then(function (result) {
    ...
    async.waterfall([loginAPICall, push], function (err, result) {
        if (err) {
...
exports.deleteApp = function (options, callback) {
